...
class Dataset(torch.utils.data.Dataset):
    def __init__(self, split):
        ...
        #离线加载数据集
        # dataset = load_from_disk(dataset_path='../data/teacher_data')[split]
        dataset = load_from_disk(dataset_path='/Users/zard/Documents/GitHub/NER_in_Chinese/data/teacher_data')[split]
